...
public class DartHamClientCodegen extends DefaultCodegen implements CodegenConfig {
    private static final Logger LOGGER = LoggerFactory.getLogger(DartHamClientCodegen.class);
    ...
    public DartHamClientCodegen() {
        ...
        embeddedTemplateDir = templateDir = "dart2-ham";
        apiPackage = "api";
        modelPackage = "model";
    ...
    public void processOpts() {
        ...
        final String libFolder = sourceFolder;
